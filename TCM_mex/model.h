...
#define COUNT_CLOUD     1e-20       /* count cloud opacity if greater than this number */
#define MAXTRIES        10          /* Maximum number of iterations to fit deep temperature */
