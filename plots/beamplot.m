function [b1,b2,b3,b1w,b2w,b3w]=beamplot
% For generating beam samples with 2pi symm in theta, with beamwidth of phi
% N Number of original spacing in theta
Ntheta_0=4;  % Ntheta- first rings number of points
BWHM=0.33;
Nphi=3;	% Number of total phi rings 
...
a1=zeros(size(x1));
h1=quiver3(a1,a1,a1,x1,y1,z1,0,'k.')
hold on
a2=zeros(size(x2));
h2=quiver3(a2,a2,a2,x2,y2,z2,0,'k.')
a3=zeros(size(x3));
h3=quiver3(a3,a3,a3,x3,y3,z3,0,'k.')


plot3(x1,y1,z1,'k.')
plot3(x2,y2,z2,'k.')
plot3(x3,y3,z3,'k.')
xlabel('\fontsize{14} Z (km)')
ylabel('\fontsize{14} Y (km)')
zlabel('\fontsize{14} X (km)')
