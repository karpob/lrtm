function alphanh3=falphabg(f,T,P_H2,P_He,P_NH3)
...
[gammaNH3,psiNH3] = bgparametersnh3(To,T,PH2,PHe,PNH3);
...
% NOW DO IT WITH GHz THEN CONVERT
Fbr=(1/GHztoinv_cm).*brlineshape(f,fo,gammaNH3,psiNH3,pst);
