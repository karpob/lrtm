function [Tbeam,jims_zenith,wfwa,...
          ...
          intercepts_c,intercepts_d]= maintamone(Spherecenter,Sphereradius,Raydirection,Rayorigin,...
                                                 ...
                                                 select_ammonia_model,select_water_model,include_clouds,N_ring_one,BWHM)
global CRITICALFLAG
...
kappa=findkappa(f,T,P,P_H2,P_He,P_NH3,P_H2O,P_CH4,P_PH3,P_H2S,...
                ...
                select_ammonia_model,select_water_model,include_clouds);
