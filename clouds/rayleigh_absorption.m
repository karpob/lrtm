function alpha=rayleigh_absorption(f,Cloud_Bulk_Density,Material_Density,Complex_Dielectric_Constant)
%absorption for small spheres in the rayleigh limit. 
%Cloud Bulk density in grams/m^3
%Material Density in grams/m^3
