 ...
 load He_0_3_eq
 dlmwrite('He_0_3_eq_Tbeam.dat',Tbeam_nadir,'\t')
 plot(Tbeam_nadir,'+b')
 hold on;
 
 load He_0_34_eq
 dlmwrite('He_0_34_eq_Tbeam.dat',Tbeam_nadir,'\t')
 plot(Tbeam_nadir,'+k')
 
 load He_0_9_eq
 dlmwrite('He_0_9_eq_Tbeam.dat',Tbeam_nadir,'\t')
 plot(Tbeam_nadir,'+g')
 
 load He_0_11_eq
 dlmwrite('He_0_11_eq_Tbeam.dat',Tbeam_nadir,'\t')
 plot (Tbeam_nadir,'+r')
 
 load He_0_3_auto
 dlmwrite('He_0_3_eq_auto_Tbeam.dat',Tbeam_nadir,'\t')
 plot (Tbeam_nadir, 'ob')

 load He_0_34_eq_auto
 dlmwrite('He_0_34_eq_auto_Tbeam.dat',Tbeam_nadir,'\t')
 plot (Tbeam_nadir,'ok')
 
  
 load He_0_9_eq_auto
 dlmwrite('He_0_9_eq_auto_Tbeam.dat',Tbeam_nadir,'\t')
 plot (Tbeam_nadir, 'og')
 
 load He_0_11_eq_auto
 dlmwrite('He_0_11_eq_auto_Tbeam.dat',Tbeam_nadir,'\t')
 plot (Tbeam_nadir, 'or')
 ...
 figure(1000)
 load He_0_3_eq
 dlmwrite('He_0_3_eq_residual.dat',residual,'\t')
 plot(residual,'+b')
 ...
 load He_0_9_eq
 dlmwrite('He_0_9_eq_residual.dat',residual,'\t')
 plot(residual,'+g')
 ...
 load He_0_3_auto
 dlmwrite('He_0_3_eq_auto_residual.dat',residual,'\t')
 plot (residual, 'ob')
 
 load He_0_34_eq_auto
 dlmwrite('He_0_34_eq_auto_residual.dat',residual,'\t')
 plot (residual,'ok')
 
 load He_0_9_eq_auto
 dlmwrite('He_0_9_eq_auto_residual.dat',residual,'\t')
 plot (residual, 'og')
 
 load He_0_11_eq_auto
 dlmwrite('He_0_11_eq_auto_residual.dat',residual,'\t')
 plot (residual, 'or')
